...
description: "This article discusses basic markdown syntax."
images: []
resources:
...
This article discusses examples of basic Markdown syntax that can be used in Hugo content files.
...
If you want to know more comprehensively, please read the [Markdown Syntax](../theme-documentation-content#extended-markdown-syntax) page.

{{< /admonition >}}

Writing content for the Web is tedious. WYSIWYG editors help alleviate this task, but they generally result in messy code, or worse yet, ugly web pages.

Markdown is a better way to write HTML, without all the complexities and ugliness that usually accompanies it.

Some of the key benefits of Markdown are:

1. Markdown is easy to learn, with minimal extra characters, so it's also quicker to write content.
2. Less chance of errors when writing in Markdown.
3. Produces valid XHTML output.
4. Keeps content and visual display separate, so you cannot mess up the look of your site.
...
{{< admonition tip >}}
:smile: Bookmark this page for easy future reference!
{{< /admonition >}}
...
Body copy is written as normal, plain text and will be wrapped with `<p></p>` tags in the rendered HTML.
...
Task lists allow you to create a list of items with checkboxes. To create a task list, add dashes (`-`) and brackets with a space (`[ ]`) before task list items. To select a checkbox, add an x between the brackets (`[x]`).
```markdown
...
{{< admonition >}}
[Syntax highlighting page](https://gohugo.io/content-management/syntax-highlighting/) in **Hugo** Docs introduces more about syntax highlighting, including highlight shortcodes.
{{< /admonition >}}
...
The rendered output looks like this (hover over the link, there is a tooltip):
...
That's the article about basic Markdown syntax. Hope it's useful. 😙